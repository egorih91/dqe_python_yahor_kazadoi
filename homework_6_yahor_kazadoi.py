...
from homework_4_3_yahor_kazadoi import case_modifying
...
class Publication:
    ...
    def print_result(self, result_list):
        if isinstance(result_list[0], str):  # if our result_list contains only strings we insert them to the final file
            self.insert_strings_into_file(result_list)
